...
// TEST_CASE("Image scale(36, 1000) scales the image to no wider than 36 pixels", "[weight=1][part=1]") {
//   Image img = createRainbowImage();
//   img .writeToFile("rainbowShit.png");
//   Image result = createRainbowImage();
//   result.scale(36, 1000);
//   result.writeToFile("scale1.png");
//   // REQUIRE( result.getPixel(100, 20)->h > 180 );
//   // REQUIRE( result.getPixel(100, 20)->h < 220 );
// }


// TEST_CASE("Image scale(1000, 120) scales the image to no taller than 120 pixels", "[weight=1][part=1]") {
//   Image img = createRainbowImage();
  
//   Image result = createRainbowImage();
//   result.scale(1000, 120);
//   result.writeToFile("scale2.png");
//   // REQUIRE( result.getPixel(100, 20)->h > 180 );
//   // REQUIRE( result.getPixel(100, 20)->h < 220 );
// }
